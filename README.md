...
- Episode season numbers are limited by the selected season count and auto-populate from the user-entered Season Number values so each added season receives the selected number of episodes
